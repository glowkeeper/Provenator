...
2. Edit the file [blockchain/truffle.js](/blockchain/truffle.js) so the default _from address_ is the [MetaMask](https://metamask.io/) address from above
...
1. Load the **Provinator** frontend by using the hash of the [build](build) directory generated by `ipfs add` above. For example, imagine the address was QmXtrx1KYiJHriwAKFZTQd1ZLeqKxJQfFkgus4VjmcDu7g, then the URL would be [https://gateway.ipfs.io/ipfs/QmdMTucY6CfpH8Yx5orCyq2enYgyKXiqo8hKimozNDwfp6](https://gateway.ipfs.io/ipfs/QmdMTucY6CfpH8Yx5orCyq2enYgyKXiqo8hKimozNDwfp6)
