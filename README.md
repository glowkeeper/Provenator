...
Follow the instructions in the [Ganache](https://github.com/trufflesuite/ganache) repository for downloading and running Ganache. Once you have all the prerequisites, and Ganache is running, type `npm install` in this repository's home directory. That should install everything in the [package.json](/package.json), which forms the REACT-based web frontend to this application.

Now, publish the contracts to the [Ganache](https://github.com/trufflesuite/ganache) blockchain instance:
