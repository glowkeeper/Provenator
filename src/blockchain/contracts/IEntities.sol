...
abstract contract IEntitiesFactory {
    ...
    function addEntity(CreativeEntities memory _entity, EntityTypes _type, bytes32 _parentId) virtual public;
    function amendEntity(CreativeEntities memory _entity, EntityTypes _type, bytes32 _parentId) virtual public;
